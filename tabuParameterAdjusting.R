...
for(tabu_list_size in 1:nr_tests){
  tabuNW_temp <- tabu(d, score =score_methods[tabu_list_size], maxp = Inf)
  #plot.new()
  ...
  tabu_avg_parentchild[tabu_list_size,] <- c(mean(as.numeric(tabuNW_temp_parentchild[,2])),
